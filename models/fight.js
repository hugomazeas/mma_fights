...
LEFT JOIN fighter fw ON f.winner_id = fw.fighter_id;
    ...
    static async add_fight(fight) {
        const values = [fight.fight_round, fight.number_round, fight.round_length, fight.ufc_number, fight.event_id, fight.division, fight.card_type, fight.fighter1_id, fight.fighter2_id, fight.winner_id, fight.win_type];
    ...
    static async update_fight(fight_id, fight) {
        const values = [fight.fight_round, fight.number_round, fight.round_length, fight.ufc_number, fight.event_id, fight.division, fight.card_type, fight.fighter1_id, fight.fighter2_id, fight.winner_id, fight_id, fight.win_type];
        return await Model.pool.query('UPDATE fight SET fight_round = $1, number_round = $2, round_length = $3, ufc_number = $4, event_id = $5, division = $6, card_type = $7, fighter1_id = $8, fighter2_id = $9, winner_id = $10, win_type = $11 WHERE fight_id = $11', values);
    }
