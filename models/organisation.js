...
class Organisation extends Model{
    ...
    static async update_organisation(organisation_id, organisation) {
        const values = [organisation.name, organisation.headquarter, organisation.founded_year, organisation_id];
        return await Model.pool.query('UPDATE organisation SET name = $1, headquarter = $2, founded_year = $3 WHERE organisation_id = $4', values);
    }
